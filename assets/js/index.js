...
const CONFIG = {
    toName: "Gabriela",
    toNamePhoto: "Gabriela",
    signature: "Diego",
    letterText:
        `Mi Gabriela,

Sé que a veces tienes días difíciles, pero quiero recordarte lo increíble que eres.

Te quiero muchísimo y te aprecio con todo mi corazón. No tienes idea de cuánto te extraño.

Eres lo máximo.

Hice esto para recordarte que estoy aquí para ti y para sacarte una sonrisa, porque te mereces todo lo bonito.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function mountYouTubePlayer() {
        ...
        if (isInAppBrowser()) {
            ...
            if (window.event && window.event.type === 'click') {
                ...
                if (hint) hint.textContent = "Abrir en YouTube (Mejor experiencia)";
                if (title) title.textContent = "♪ Click para escuchar ♪";
            }
            return;
        }
        ...
        fallbackDiv.innerHTML = `
            <a href="${watchUrl}" target="_blank" class="yt-fallback-link">
                <span class="yt-icon">📺</span> Si no reproduce, click aquí
            </a>
        `;
    ...
    function resetMusicPlayer() {
        ...
        playSection.innerHTML = `
            <div class="play-title">♪ Escucha nuestra canción ♪</div>
            <button class="play-button small" id="playButton" aria-label="Reproducir canción">
                <span>▶</span>
            </button>
    ...
    function toggleLetter() {
        if (letterEl.classList.contains("open")) {
            ...
            openBtn.innerHTML = 'Cerrar carta';
